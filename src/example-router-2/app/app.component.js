System.register(['angular2/core', 'angular2/router', './crisis-list.component', './heroes/hero-list.component', './heroes/hero-detail.component', './heroes/hero.service'], function(exports_1) {
    ...
    var core_1, router_1, crisis_list_component_1, hero_list_component_1, hero_detail_component_1, hero_service_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
